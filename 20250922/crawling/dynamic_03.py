...
more = driver.find_element(By.CSS_SELECTOR,'#autodanawa_gridC > div.gridMain > article > main > div > div:nth-child(4) > div.left > a')
more.click()
time.sleep(2)
# 기간선택 레디오 버튼
...
btn = driver.find_element(By.CSS_SELECTOR,"input[value='조회']")
btn.click()
